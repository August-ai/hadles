<?php require "headerS.php"; ?>
  ...
  <div class="signup-div">
    ...
    <hr id="f-hr">
    <?php
    echo '<form class="signup-form" action="includes/signuppayment.inc.php?signincheckout&o='.$_GET["o"].'&donationamount='.$_GET["donationamount"].'&donation='.$_GET["donation"].'&rest='.$_GET["rest"].'" method="post">';
    ...
    ?>
      ...
      <?php echo '<p class="re-lo">Already have an account? <a href="login_pay.php?signincheckout&o='.$_GET["o"].'&donationamount='.$_GET["donationamount"].'&donation='.$_GET["donation"].'&rest='.$_GET["rest"].'">Sign in</a></p>';
     ?>
    </div>
    </form>
  </div>
