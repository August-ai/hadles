<?php require "headerPaymentS.php";
    ...
    <div class="checkout-container">
      <div class="checkout-info" id="checkout-top">
        <div class="organization-name_payment body-full">
          <!-- <span class="right-side-text-payment"></span>
          <span class="left-side-text-payment">Action Against Hunger</span>
