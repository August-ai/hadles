...
$donationA = $_POST['amount'];

if (isset($_POST["donation-checkbox"])) {
  $rest = ($donationA/100) * 6;
}else {
  $rest = 0;
}
 ?>
...
if (isset($_GET["Error"])) {
 ...
 ?>
    ...
    <br>
    <hr id="f-hr"/>
    <?php echo "<form action='includes/login_payment.inc.php?signincheckout&o=".$_GET['o']."&donationamount=".$donationA."&donation=".$_POST['donationG']."&rest=".$rest."' method='post' >"; ?>
      <div id="rec-line3">
    ...
    <?php echo "<p class='re-lo'>New to Hadles? <a href='signuppayment.php?signincheckout&o=".$_GET['o']."&donationamount=".$donationA."&donation=".$_POST['donationG']."&rest=".$rest."'>Create an account</a></p>"; ?>
  </div>
  <br>
<div id="rec-line4">
...
<!-- <div class='continue-guest_div'>
  <a href='payment.php?action=ckeckoutsession=".$_GET["o"]."&donationamount=".$_POST['amount']."'>Continue as guest</a><br>
</div> -->
